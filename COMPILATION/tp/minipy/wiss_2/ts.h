...
int gettype(char entite[],idf *t)
{
	...
	if(t1 != NULL)
    {
		if(strcmp("int",t1->type)==0){ return 0;
		}else {
			if(strcmp("float",t1->type)==0){return 2;
			}else return 1;
		}
	}
}
